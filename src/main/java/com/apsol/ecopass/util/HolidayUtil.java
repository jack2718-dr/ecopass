...
public class HolidayUtil {
     ...
     */
    public static String isHoliday(String date, int dateNum) {
        ...
        try {
            ...
            for (int i = 1; i <= dateNum; i++) {
                ...
                if (isHolidaySolar(resultDate) || isHolidayLunar(resultDate)
                    || isHolidayAlternate(resultDate) || isWeekend(resultDate)) {
                    dateNum += 1;
                }
            }
    ...
    private static boolean isHolidayAlternate(String date) {
        ...
        String[] altHoliday = new String[]{
            "20200127", "20200817", "20220912", "20230124",
            "20240212", "20240506", "20251008",
